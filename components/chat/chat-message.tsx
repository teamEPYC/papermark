...
const mapMessageRole = {
  ...
  assistant: { icon: <PapermarkSparkle />, name: "SeedToScale Assistant" },
  function: { icon: <PapermarkSparkle />, name: "SeedToScale Assistant" },
  data: { icon: <PapermarkSparkle />, name: "SeedToScale Assistant" },
  tool: { icon: <PapermarkSparkle />, name: "SeedToScale Assistant" },
};
